...
import com.zgzx.metaphysics.city_time_picker.xpopupext.view.WheelTime;
...
public class TimePickerPopup extends BottomPopupView {
    ...
    public enum Mode {YMDHMS, YMDHM, YMDH, YMD, YM, Y}
    ...
    private Calendar startDate, endDate = Calendar.getInstance();
...
//    public int textColorCenter = 0xFF2a2a2a; //分割线之间的文字颜色
    ...
    protected void onCreate() {
        super.onCreate();
        RadioGroup calendarType = findViewById(R.id._xpopup_calendar_type);

        calendarType.setOnCheckedChangeListener((RadioGroup.OnCheckedChangeListener) (radioGroup, id) -> {
            if (id == R.id._xpopup_lunar_calendar) {
                setLunar(true);

            } else if (id == R.id._xpopup_gregorian_calendar) {
                setLunar(false);
            }
        ...
        btnConfirm.setOnClickListener(v -> {
            if (timePickerListener != null) {
                ...
                try {
                    ...
                    timePickerListener.onTimeConfirm(
                            wheelTime.getString(),
        ...
        // 选择
        calendarType.check(isLunar ? R.id._xpopup_lunar_calendar : R.id._xpopup_gregorian_calendar);
    }
...
//    }
    ...
    private void setTime() {
        ...
        // 默认选中未知
        wheelTime.setPicker(year, month, day, 0, minute, seconds);
    }
