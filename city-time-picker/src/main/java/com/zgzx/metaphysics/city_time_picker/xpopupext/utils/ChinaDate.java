package com.zgzx.metaphysics.city_time_picker.xpopupext.utils;
...
//            years.add(String.format("%s(%d)", getLunarYearText(i), i));
     ...
     * @return 月份列表
     */
    public static ArrayList<String> getMonths(Resources resources, int year) {
        String[] stringArray = resources.getStringArray(R.array._xpopup_ext_lunar_month);
        String month = resources.getString(R.string._xpopup_ext_month);
        String leap = resources.getString(R.string._xpopup_ext_leap);

        ArrayList<String> baseMonths = new ArrayList<>();
        for (int i = 1; i < stringArray.length; i++) {
            baseMonths.add(stringArray[i] + month);
        }
        if (leapMonth(year) != 0) {
            baseMonths.add(leapMonth(year), leap + nStr1[leapMonth(year)] + month);
        }
        return baseMonths;
    }
    ...
    public static ArrayList<String> getLunarHours(Resources resources) {
        ArrayList<String> list = new ArrayList<>();

        String lunarHour = resources.getString(R.string._xpopup_placeholder_lunar_hour);
        String[] zhiArr = resources.getStringArray(R.array._xpopup_ext_lunar_zhi);

        for (int i = 1; i < zhiArr.length; i++) {
            list.add(String.format(lunarHour, zhiArr[i], (i * 2 - 1)));
            list.add(String.format(lunarHour, zhiArr[i], (i * 2)));
        }

        // 子时
        list.add(String.format(lunarHour, zhiArr[0], 23));
        list.add(String.format(lunarHour, zhiArr[0], 0));
        return list;
    }


    public static ArrayList<String> getHours(Resources resources) {
...
//        list.add("未知");
        ...
        list.add("7:00-8:59");
        list.add("9:00-10:59");
        list.add("11:00-12:59");
        list.add("13:00-14:59");
        list.add("15:00-16:59");
        list.add("17:00-18:59");
        list.add("19:00-20:59");
        list.add("21:00-22:59");
        return list;
    }
}
