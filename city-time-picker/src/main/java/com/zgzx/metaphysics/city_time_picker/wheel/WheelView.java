package com.zgzx.metaphysics.city_time_picker.wheel;
...
public class WheelView extends View {
    ...
    private Typeface mFontTypeface = Typeface.MONOSPACE;//字体样式，默认是等宽字体
    ...
    public WheelView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        if (attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.WheelView, defStyleAttr, R.style.wheelViewStyle);
            mGravity = a.getInt(R.styleable.WheelView_gravity, 0);
            textColorOut = a.getColor(R.styleable.WheelView_textColorOut, 0);
            textColorCenter = a.getColor(R.styleable.WheelView_textColorCenter, 0);
            dividerColor = a.getColor(R.styleable.WheelView_dividerColor, 0);
            dividerWidth = a.getDimensionPixelSize(R.styleable.WheelView_dividerWidth, 0);
            textSize = a.getDimensionPixelOffset(R.styleable.WheelView_textSize, 0);
            lineSpacingMultiplier = a.getFloat(R.styleable.WheelView_lineSpacingMultiplier, 0);
            int textStyle = a.getInt(R.styleable.WheelView_textStyle, 0);

            // 字体
            String fontFamilyName = a.getString(R.styleable.WheelView_fontFamily);
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O){
                mFontTypeface = a.getFont(R.styleable.WheelView_fontFamily);

            } else {
                mFontTypeface = Typeface.create(fontFamilyName, Typeface.NORMAL);
            }

            mFontTypeface = TypefaceCompat.create(context, mFontTypeface, textStyle);
    ...
    private void initPaints() {
        ...
        paintOuterText.setTypeface(mFontTypeface);
        ...
        paintCenterText.setTypeface(mFontTypeface);
