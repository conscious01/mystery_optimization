...
public class FateBooksEntity {
     ...
     * status : 0
     * is_my : 1
     * abstract : {"horoscope":{"value":"狮子座","match":["白羊座","狮子座","射手座"]},"zodiac":{"value":"狗","match":["兔","马","虎"]},"bazi":{"value":["丙戌","乙未","辛酉","戊子"],"match":["辰","巳","丑"]}}
     * cate : [{"cate_id":30,"name":"自身","sub_cate":["性格","才能","潜在个性及心理状况","整体建议","生活与物质品味的优劣","先天较弱的器官","容易得到的疾病","一生疾病的轻重","解压良方","建议积福方法"],"is_buy":true},{"cate_id":31,"name":"爱情","sub_cate":["感情运","理想的另一半","另一半的个性","与另一半的相处模式","另一半与你相处的良方","另一半处理冷战局势的良方","性生活表现","增加情趣及翻倍享受的方法"],"is_buy":true},{"cate_id":32,"name":"事业及学业","sub_cate":["发展倾向","能力","适合从事的行业","适合打工或创业","创业方向","合伙创业趋势","部属类型及相处状况","出外际遇与状况","给予别人的印象","伯乐类型","学习态度","提升学习能力的方法"],"is_buy":true},{"cate_id":33,"name":"资产及财运","sub_cate":["整体财运","财富性质及多寡","对财富的态度或进财 方法","控制支出的方法","致富之道","不动产状况","祖业庇荫状况","居家环境"],"is_buy":true},{"cate_id":34,"name":"家庭及人际","sub_cate":["父母个性","与父母的感情","父母的影响","兄弟姊妹个性及关系","生育能力及子女特质","培育子女的方法","朋友类型及相处状况","交友倾向"],"is_buy":true}]
     */
    ...
    public static class AbstractBean {
         ...
         * zodiac : {"value":"狗","match":["兔","马","虎"]}
         * bazi : {"value":["丙戌","乙未","辛酉","戊子"],"match":["辰","巳","丑"]}
         */
