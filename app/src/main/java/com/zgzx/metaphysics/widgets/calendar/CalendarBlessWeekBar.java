...
public class CalendarBlessWeekBar extends WeekBar {
    private int mPreSelectedIndex;

    public CalendarBlessWeekBar(Context context) {
        super(context);
        LayoutInflater.from(context).inflate(R.layout.view_calendar_week_bless_bar, this, true);
    }
    ...
    private String getWeekString(int index, int weekStart) {
        String[] weeks = getContext().getResources().getStringArray(R.array.calendar_week_string_array);
