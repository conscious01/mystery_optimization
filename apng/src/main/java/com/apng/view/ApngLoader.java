...
public class ApngLoader {
    ...
    public  void loadApngListener(String apngPath, ApngImageView view, ApngImageView.AnimationListener listener){
        AnimParams animItem2 = new AnimParams();
        animItem2.imagePath = apngPath;
        animItem2.loopCount = AnimParams.PLAY_4_LOOP;
        view.setApngForPlay(animItem2);
